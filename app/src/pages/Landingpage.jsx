                        ...
                        <div className='relative group'>
                            ...
                            <div className='relative bg-white dark:bg-gray-900 rounded-2xl p-8 h-full hover:-translate-y-2 transition-transform duration-300 shadow-xl'>
                                ...
                                <div className='flex flex-col h-full'>
                                    ...
                                    <button className='w-full py-3 px-4 rounded-xl font-medium bg-gradient-to-r from-[#4785FF] to-[#8c52ff] text-white hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300'>
                                        Jetzt upgraden
                                    </button>
                                </div>
                            </div>
